      ...
      <div className="projects-grid">
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/AI_based-Image_to_3D_model_generator" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
            </div>
          </div>
        </div>
        ...
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/Blockchain-Cryptocurrency-Exchange.git" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
            </div>
          </div>
        </div>
        ...
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/Smart-Contract-Extraction-with-AI" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
            </div>
          </div>
        </div>
        ...
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/AI-enabled-csv-Modifier" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
            </div>
          </div>
        </div>
        ...
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/MAYA-The-chat-bot.git" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
        ...
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/Django-Event-manager.git" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
            </div>
          </div>
        </div>
        ...
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/AI-Startup-builder.git" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
            </div>
          </div>
        </div>
        ...
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/NFT-market-place-on-Hive.git" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
            </div>
          </div>
        </div>
        ...
        <div className="project-item">
          ...
          <div className="project-content">
            ...
            <div className="project-links">
                              <a href="https://github.com/Shikharcodes13/My-replication-voicebot.git" target="_blank" rel="noopener noreferrer" className="project-link">GitHub</a>
            </div>
          </div>
        </div>
      </div>
