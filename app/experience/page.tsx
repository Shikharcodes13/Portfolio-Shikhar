...
export default function ExperiencePage() {
  return (
    <div className="blue-bg min-h-screen flex flex-col items-center justify-start">
      ...
      <div className="mac-window-continuous">
        ...
        <div className="mac-header-continuous">
          ...
          <div className="mac-title">Shikhar Parashar</div>
        ...
        <div className="mac-content-continuous">
          ...
          <footer className="footer-mac">
                          <div>shikharcodes13@gmail.com</div>
            <div className="footer-socials-mac">
              <a className="footer-social-mac" href="https://www.linkedin.com/in/shikhar-parashar-065128231/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <FontAwesomeIcon icon={faLinkedin} />
              </a>
              <a className="footer-social-mac" href="https://github.com/Shikharcodes13" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <FontAwesomeIcon icon={faGithub} />
              </a>
              <a className="footer-social-mac" href="https://leetcode.com/u/shikharcodes13/" target="_blank" rel="noopener noreferrer" aria-label="LeetCode">
                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
